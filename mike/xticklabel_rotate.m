...
varargin = varargin(2:length(varargin));% Example 3:  Set the positions of the XTicks and rotate them 90% Example 1:  Rotate existing XTickLabels at their current position by 90
