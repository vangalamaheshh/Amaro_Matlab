...
%
%   20010-10-28 give Aviad's data a test run
%
...
tic
R.dep = hairpin_permtest(@stat_diffmean,scores,dep(cgx,:),ind(cgx,:),classes,permtest_options);
toc
% save intermediate results
n = write_hp_permstats([output_dir DATA_ID '.CDKN2A.diffmean.LR.bin.101029.tab'],R.dep,gmatch,AC,G,cyto,'dep','ind');
...
toc
% save intermediate results
n = write_hp_permstats([output_dir DATA_ID '.alldels.HP.diffmean.LR.bin.101015.tab'],R.del,gmatch,AC,G,cyto,'any del','no del');
...
toc
% save intermediate results
n = write_hp_permstats([output_dir DATA_ID '.allamps.diffmean.LR.bin.101029.tab'],R.amp,gmatch,AC,G,cyto,'any amp','no amp');
verbose('wrote %d unfiltered amplification permutation statistics across hairpins',20,n);
