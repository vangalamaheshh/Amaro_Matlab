function [CL,P,batches,snps,all_mn,notref]=preprocess_snp_data(M,perform_correct_batch_effect,divide_by_normals,use_median_scale,use_n_close_normals,use_matched_normal,use_all_cores_for_ref,use_median_of_ref,use_tangent_normalization)
...
if median(ML1.dat(:))>0.5
  ML1.dat(ML1.dat<1)=1;
  ML1.dat=log2(ML1.dat)-1;
end
...
if use_median_scale==0 % scale samples 
...
if (use_median_scale==1) % scale samples 
