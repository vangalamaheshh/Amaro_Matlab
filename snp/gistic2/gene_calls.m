function gene_calls(run_dir,params,cyto_file)
%GENE_CALLS create copy number alteration calls for genes on all samples
%
%     gene_calls(RUN_DIR,PARAMS,CYTO_FILE)
%     gene_calls(RUN_DIR,EXT,CYTO_FILE)  [older form]
%
...
% (no file name will be used). The CYTO_FILE argument is a path to the file
% that contains the 'cyto' structure used to identify genomic features.
...
% See the accompanying file LICENSE.txt for licensing details.
  ...
  A=read_by_gene_file([pathbase 'all_data_by_genes' ext '.txt'],cyto_file);                      
