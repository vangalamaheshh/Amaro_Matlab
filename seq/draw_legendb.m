...
cn_colors = { blue, ltblue, ltpurple, ltred, red, dkgrey };

cn_labels = {'HomoDel','HemiDel','Neutral','LowAmp','HighAmp','No CN data'};
...
for i=1:length(cn_labels)
  draw_shape('cir',x1,y,cn_colors{i});
  text(x2,y,cn_labels{i});
  y=y+yincr;
end
...
hold off
print('-dpng','-r250','-zbuffer','legendb.png');
success = true;
return
