function [] = startFilterMAFFile(mafFilename, outputMAFFilename, outputDir, isCheckForMatFile)
% [] = startFilterMAFFile(mafFilename, outputMAFFilename, outputDir, isCheckForMatFile)
% 
%
...
outputTableDir = [outputDir '/tables/'];
...
disp('Temporarily disabling the figure generation')
