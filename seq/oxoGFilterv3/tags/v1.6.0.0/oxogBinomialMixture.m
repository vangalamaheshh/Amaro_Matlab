function [Noxo,Nmut,alf,alfci,NoxoCI] =  OxogBinomialMixture(NALT,NART,AC,PoxoG,p0,alphaci)
% function [Noxo,Nmut,alf,alfci,eNoxo] =  OxogBinomialMixture(NALT,NART,AC,PoxoG,p0)
