...
% TODO: Documentation
%
% Putting [] for fdrStruct or fogogX will cause this script to skip the
%  patch plotting and filtering information in text blurb.

isPlottingPatch = 1;
if isempty(foxogX) || isempty(fdrStruct)
   disp(['No plotting a patch or displaying filtering info: ' uname]); 
   isPlottingPatch = 0;
end
...
if isPlottingPatch
    ...
    filteredMutationsString = '';
    filteredMutationsStringLine2 = '';
    filteredMutationsStringLine3 = '';
end
