...
%   picard_oxoQ -- value for oxoG effect on base quality
%
...
unameRefF2R1 = mafTable.i_t_REF_F1R2(unameIndices);
unameOxoQ = mafTable.i_picard_oxoQ(unameIndices);
...
R_A.i_picard_oxoQ = R.i_picard_oxoQ(R_A_i);
...
R_nA.i_picard_oxoQ = R.i_picard_oxoQ(R_nA_i);
