...
if tot_n_noncoding==0
  ...
  ok=true;
  if tot_n_noncoding<min_tot_n_noncoding, fprintf('WARNING:  not enough noncoding mutations to analyze\n'); ok=false; end
  if tot_rate_noncoding<min_rate_noncoding || tot_rate_noncoding>max_rate_noncoding, fprintf('WARNING:  noncoding mutation rate out of range\n'); ok=false; end
