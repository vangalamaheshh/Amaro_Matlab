...
y = fig.legend.y;
    ...
    M3.color{1}=[72/255 61/255 139/255] ;
    M3.color{2}=[1 99/255 71/255];
    M3.color{3}=[1 165/255 0/255];
    %M3.color{4}=[50/255 205/255 50/255];
