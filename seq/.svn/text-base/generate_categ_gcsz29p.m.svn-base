function generate_categ_gcsz29p(cset)

% creates gcsz29p category files
%
...
outdir = '/xchip/cga1/lawrence/db/gcsz29p';
...
for cidx=1:length(cset)
  ...
  c = load(['/xchip/cga1/lawrence/db/regulatory29/' cname '.mat']); c=c.r;      % F=noncons T=cons
