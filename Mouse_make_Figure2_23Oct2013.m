...
%%
% broad
subplot('position',[0.62 0.1 0.08 0.8])
...
subplot('position',[0.7 0.1 0.08 0.8])
[i m]=ismember(Q.B.names,MM9A.arm)
...
% focal 
subplot('position',[0.80 0.1 0.08 0.8])
...
subplot('position',[0.88 0.1 0.08 0.8])
