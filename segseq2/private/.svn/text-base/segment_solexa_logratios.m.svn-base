function [SEG,S2,BKP,POS,R,pval,CHR,stepTimes]=segment_solexa_logratios( READN, READT, chrLengthFile, chrs, W, aN, aT, p_bkp, p_merge, flagSpeedup )
...
step_time=toc;
fprintf(1,'\n5) Calculate tumor read statistics:  %f', step_time);
...
step_time=toc;
fprintf(1,'\n6) Filter tumor initial bkp candidates:  %f', step_time);
...
step_time=toc;
fprintf(1,'\n7) Initialize TUMOR segment statistics:  %f',step_time);
