...
%   animals2(mj)
%
%   Revised 9/10/07: Matching algorithm reimplemented with REPMAT rather 
%       than FOR loops to increase speed.  
%        Jen Dobson
...
% [ss12,i12,j12]=unique([ strvcat(set1, set2) ],'rows'); 
% n1=size(set1,1);
% n2=size(set2,1);
