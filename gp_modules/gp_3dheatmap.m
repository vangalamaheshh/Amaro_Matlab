function gp_3dheatmap(varargin)
% gp_3dheatmap -o xxx.png -ot 1 -d xxx.gct -dp 1 -cnc 1 -smooth 0.7071 -p Tissue Type -c xxx.cls -cc
% color_table.txt -l 1
%% -gd xxx.gdend.odf -gdr 1 -sd xxx.sdend.odf -sdr 1
%% -sf 5 -gf 10 -sx 0.1 0.3 0.4 -sy 0.2 0.1 0.1 0.4 0.1 -lnc 1 -ltf 14 -lf 14 

a=handle_args({'o','ot','d','dp','cnc','smooth','p','c','cc','l'},varargin);
%% 'gd','gdr','sd','sdr','sf','gf','sx','sy','lnc','ltf','lf'},varargin);
...
if ~isempty(a.c)
  ...
  D.supmark(1).x_3d=1;
  D.supmark(1).y_3d=0.05;
  D.supmark(1).y_3d_gap=0.02;
  D.supmark(1).z_3d=0.1;
end

if ~isempty(a.cnc)
  cn_color=str2num(a.cnc{1});
else
  cn_color=1;
end

if ~isempty(a.smooth)
  smooth=str2num(a.smooth{1});
else
  smooth=1/sqrt(2);
end
...
close all
figure(1);
%heatmap3d(D,1,1,1/sqrt(2));
heatmap3d(D,cn_color,1,smooth); %,str2num(a.pad),str2num(a.th));
