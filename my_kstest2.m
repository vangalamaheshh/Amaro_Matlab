function [H,pValue,KSstatistic,KS_core] = my_kstest2(x1 , x2 , alpha , tail)
...
if size(binCounts1,1)==1
  binCounts1=binCounts1';
end
binCounts2  =  histc (x2 , binEdges);
if size(binCounts2,1)==1
...
[KSstatistic,KSstatistic_idx]   =  max(deltaCDF);
KS_core=length(find(x1<=binEdges(KSstatistic_idx)));
%
